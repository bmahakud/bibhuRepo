...
const unsigned double labelsize=0.047;
...
/////////////////////////////////////
/*
TLatex *tex1 = new TLatex(14.29561,121.0426,"CMS");
   tex1->SetTextSize(0.0492228);
   tex1->SetLineWidth(2);
 
TLatex  *tex2 = new TLatex(19.12744,121.3585,"Simulation Preliminary");
   tex2->SetTextFont(12);
   tex2->SetTextSize(0.0492228);
   tex2->SetLineWidth(2);
   
TLatex *tex3 = new TLatex(44.21424,121.5798,"13 TeV");
   tex3->SetTextSize(0.04533679);
   tex3->SetLineWidth(2);
   
TLatex *tex4 = new TLatex(14.58552,111.5645,"QCD, Anti-kT (R=0.8)");
   tex4->SetTextSize(0.0492228);
   tex4->SetLineWidth(0);
   
 TLatex *tex5 = new TLatex(14.82711,103.3502," 300< p_{T}< 470 GeV");
   tex5->SetTextSize(0.0492228);
   tex5->SetLineWidth(0);
   
TLatex *tex6 = new TLatex(17.4363,94.81992," |#eta|< 2.5");
   tex6->SetTextSize(0.05051813);
   tex6->SetLineWidth(0);
...
TLatex *   tex1 = new TLatex(13.56301,121.3585,"CMS");
   tex1->SetTextSize(0.0388601);
   tex1->SetLineWidth(2);
  
 TLatex *tex2 = new TLatex(16.95707,121.3585,"Simulation Preliminary");
   tex2->SetTextFont(52);
   tex2->SetTextSize(0.03238342);
   tex2->SetLineWidth(2);
   
 TLatex *tex3 = new TLatex(47.83363,121.8324,"13 TeV");
   tex3->SetTextFont(42);
   tex3->SetTextSize(0.03367876);
   tex3->SetLineWidth(2);
   /*
TLatex *tex4 = new TLatex(15.02434,112.0384,,"QCD, Anti-kT (R=0.8)");
   tex4->SetTextFont(42);
   tex4->SetTextSize(0.04404145);
   tex4->SetLineWidth(0);
   
 TLatex *tex5 = new TLatex(14.78864,103.5082,"  p_{T} > 300 GeV");
   tex5->SetTextFont(42);
   tex5->SetTextSize(0.04404145);
   tex5->SetLineWidth(0);
   
TLatex *tex6 = new TLatex(14.83578,94.66195," |#eta|< 2.5");
   tex6->SetTextFont(42);
...
TLatex *tex4 = new TLatex(14.69436,112.0384,"QCD, Anti-kT (R=0.8)");
   tex4->SetTextFont(42);
   tex4->SetTextSize(0.04404145);
   tex4->SetLineWidth(0);
   
tex5 = new TLatex(14.69436,105.5617,"<n_{PU}>= 40");
   tex5->SetTextFont(42);
   tex5->SetTextSize(0.04404145);
   tex5->SetLineWidth(2);


 TLatex *tex6 = new TLatex(14.69436,98.29521,"p_{T} > 300 GeV");
   tex6->SetTextFont(42);
   tex6->SetTextSize(0.04404145);
   tex6->SetLineWidth(0);
   
TLatex *tex7 = new TLatex(14.69436,90.55521,"|#eta|< 2.5");
   tex7->SetTextFont(42);
   tex7->SetTextSize(0.04404145);
   tex7->SetLineWidth(0);


TLatex *texTrPFCHS = new TLatex(14.7415,82.18248,"PF+CHS with trimming");
   texTrPFCHS->SetTextFont(42);
   texTrPFCHS->SetTextSize(0.044074612);
   texTrPFCHS->SetLineWidth(2);


TLatex *texTrPF = new TLatex(14.7415,82.18248,"PF with trimming");
   texTrPF->SetTextFont(42);
   texTrPF->SetTextSize(0.044074612);
   texTrPF->SetLineWidth(2);


TLatex *texPrPFCHS = new TLatex(14.7415,82.18248,"PF+CHS with pruning");
   texPrPFCHS->SetTextFont(42);
   texPrPFCHS->SetTextSize(0.044074612);
   texPrPFCHS->SetLineWidth(2);


TLatex *texPrPF = new TLatex(14.7415,82.18248,"PF with pruning");
   texPrPF->SetTextFont(42);
   texPrPF->SetTextSize(0.044074612);
   texPrPF->SetLineWidth(2);


TLatex *texSdPFCHS = new TLatex(14.7415,82.18248,"PF+CHS with softdrop");
   texSdPFCHS->SetTextFont(42);
   texSdPFCHS->SetTextSize(0.044074612);
   texSdPFCHS->SetLineWidth(2);


TLatex *texSdPF = new TLatex(14.7415,82.18248,"PF with softdrop");
   texSdPF->SetTextFont(42);
   texSdPF->SetTextSize(0.044074612);
   texSdPF->SetLineWidth(2);
...
JetRsAKpf[ii2]->Fill(pf_m->at(0));

}

if(chs_ptcorrphil->at(0) > pTmin && chs_ptcorrphil->at(0) < pTmax){
JetRsAKchs[ii2]->Fill(chs_m->at(0));
...
//ungroomed below
double pf_meanX_nPV[nPVnumOfbins];
double pf_meanY_nPV[nPVnumOfbins];
double pf_meanXerr_nPV[nPVnumOfbins];
double pf_meanYerr_nPV[nPVnumOfbins];

double chs_meanX_nPV[nPVnumOfbins];
double chs_meanY_nPV[nPVnumOfbins];
double chs_meanXerr_nPV[nPVnumOfbins];
double chs_meanYerr_nPV[nPVnumOfbins];
...
JetRsAKpf[ii3]->Scale(1/JetRsAKpf[ii3]->Integral());
JetRsAKchs[ii3]->Scale(1/JetRsAKchs[ii3]->Integral());



pf_meanX_nPV[ii3]=nPVmin+ii3*nPVbinsize +(binsize/2);
pf_meanY_nPV[ii3]=JetRsAKpf[ii3]->GetMean();
pf_meanYerr_nPV[ii3]=JetRsAKpf[ii3]->GetMeanError();
pf_meanXerr_nPV[ii3]=x_err;

chs_meanX_nPV[ii3]=nPVmin+ii3*nPVbinsize +(binsize/2);
chs_meanY_nPV[ii3]=JetRsAKchs[ii3]->GetMean();
chs_meanYerr_nPV[ii3]=JetRsAKchs[ii3]->GetMeanError();
chs_meanXerr_nPV[ii3]=x_err;
...
puppi_sd_meanYerr_nPV[jj3][ii3]=JetRsAKpuppiSd_nPV_h[jj3][ii3]->GetMeanError();AnalysisThreeParVar.C
...
//TGraphErrors *pf_graph_MeanvsNpv;
//TGraphErrors *chs_graph_MeanvsNpv;
...
TGraphErrors *pf_graph_MeanvsNpv= new TGraphErrors(nPVnumOfbins,pf_meanX_nPV,pf_meanY_nPV,pf_meanXerr_nPV,pf_meanYerr_nPV);
pf_graph_MeanvsNpv->SetLineColor(6);
pf_graph_MeanvsNpv->SetLineWidth(linewidth);
pf_graph_MeanvsNpv->SetMarkerStyle(20);
pf_graph_MeanvsNpv->SetMarkerColor(6);
pf_graph_MeanvsNpv->SetMarkerSize(markersize);


TGraphErrors *chs_graph_MeanvsNpv= new TGraphErrors(nPVnumOfbins,chs_meanX_nPV,chs_meanY_nPV,chs_meanXerr_nPV,chs_meanYerr_nPV);
chs_graph_MeanvsNpv->SetLineColor(6);
chs_graph_MeanvsNpv->SetLineWidth(linewidth);
chs_graph_MeanvsNpv->SetMarkerStyle(20);
chs_graph_MeanvsNpv->SetMarkerColor(6);
chs_graph_MeanvsNpv->SetMarkerSize(markersize);
...
leg_1D[k0]=new TLegend(0.5923695,0.623057,0.7921687,0.9132124,NULL,"brNDC");//0.5,0.6,0.70,0.89);
...
TMg_1D[0]->Add(pf_graph_MeanvsNpv);

TMg_1D[0]->SetMinimum(20);
TMg_1D[0]->SetMaximum(120);
TMg_1D[0]->SetTitle(" ;n_{PV} ;< m_{trimming} > (GeV)");
TMg_1D[0]->Draw("AP");

leg_1D[0]->AddEntry(pf_graph_trMeanvsNpv[0],"r_{sub}=0.2,pT_{frac}=0.05","l");
leg_1D[0]->AddEntry(pf_graph_trMeanvsNpv[1],"r_{sub}=0.1,pT_{frac}=0.03","l");
leg_1D[0]->AddEntry(pf_graph_trMeanvsNpv[2],"r_{sub}=0.2,pT_{frac}=0.03","l");
leg_1D[0]->AddEntry(pf_graph_trMeanvsNpv[3],"r_{sub}=0.3,pT_{frac}=0.03","l");

leg_1D[0]->AddEntry(pf_graph_MeanvsNpv,"ungroomed ","l");
...
TMg_1D[1]->Add(chs_graph_MeanvsNpv);

TMg_1D[1]->SetMinimum(20);
TMg_1D[1]->SetMaximum(120);

TMg_1D[1]->SetTitle(" ;n_{PV} ;< m_{trimming} > (GeV)");
TMg_1D[1]->Draw("AP");
leg_1D[1]->AddEntry(chs_graph_trMeanvsNpv[0],"r_{sub}=0.2,pT_{frac}=0.05","l");
leg_1D[1]->AddEntry(chs_graph_trMeanvsNpv[1],"r_{sub}=0.1,pT_{frac}=0.03","l");
leg_1D[1]->AddEntry(chs_graph_trMeanvsNpv[2],"r_{sub}=0.2,pT_{frac}=0.03","l");
leg_1D[1]->AddEntry(chs_graph_trMeanvsNpv[3],"r_{sub}=0.3,pT_{frac}=0.03","l");

leg_1D[1]->AddEntry(chs_graph_MeanvsNpv,"ungroomed ","l");
...
TMg_1D[2]->SetMaximum(120);
TMg_1D[2]->SetTitle(" ;n_{PV} ;< m_{trimming} > (GeV)");
TMg_1D[2]->Draw("AP");

leg_1D[2]->AddEntry(puppi_graph_trMeanvsNpv[0],"r_{sub}=0.2,pT_{frac}=0.05","l");
leg_1D[2]->AddEntry(puppi_graph_trMeanvsNpv[1],"r_{sub}=0.1,pT_{frac}=0.03","l");
leg_1D[2]->AddEntry(puppi_graph_trMeanvsNpv[2],"r_{sub}=0.2,pT_{frac}=0.03","l");
leg_1D[2]->AddEntry(puppi_graph_trMeanvsNpv[3],"r_{sub}=0.3,pT_{frac}=0.03","l");
...
TMg_1D[3]->SetMaximum(120);
TMg_1D[3]->SetTitle(" ;n_{PV} ;< m_{trimming} > (GeV)");
TMg_1D[3]->Draw("AP");

leg_1D[3]->AddEntry(gen_graph_trMeanvsNpv[0],"r_{sub}=0.2,pT_{frac}=0.05","l");
leg_1D[3]->AddEntry(gen_graph_trMeanvsNpv[1],"r_{sub}=0.1,pT_{frac}=0.03","l");
leg_1D[3]->AddEntry(gen_graph_trMeanvsNpv[2],"r_{sub}=0.2,pT_{frac}=0.03","l");
leg_1D[3]->AddEntry(gen_graph_trMeanvsNpv[3],"r_{sub}=0.3,pT_{frac}=0.03","l");
...
TMg_1D[4]->Add(pf_graph_MeanvsNpv);

TMg_1D[4]->SetMinimum(20);
TMg_1D[4]->SetMaximum(120);
TMg_1D[4]->SetTitle(" ;n_{PV} ;< m_{pruning} > (GeV)");
TMg_1D[4]->Draw("AP");

leg_1D[4]->AddEntry(pf_graph_prMeanvsNpv[0],"z_{cut}=0.1,r_{cut}=0.5","l");
leg_1D[4]->AddEntry(pf_graph_prMeanvsNpv[1],"z_{cut}=0.05,r_{cut}=0.5","l");
leg_1D[4]->AddEntry(pf_graph_prMeanvsNpv[2],"z_{cut}=0.05,r_{cut}=0.75","l");
leg_1D[4]->AddEntry(pf_graph_prMeanvsNpv[3],"z_{cut}=0.1,r_{cut}=0.75","l");
leg_1D[4]->AddEntry(pf_graph_MeanvsNpv,"ungroomed ","l");
...
TMg_1D[5]->Add(chs_graph_MeanvsNpv);

TMg_1D[5]->SetMinimum(20);
TMg_1D[5]->SetMaximum(120);
TMg_1D[5]->SetTitle(" ;n_{PV} ;< m_{pruning} > (GeV)");
TMg_1D[5]->Draw("AP");

leg_1D[5]->AddEntry(chs_graph_prMeanvsNpv[0],"z_{cut}=0.1,r_{cut}=0.5","l");
leg_1D[5]->AddEntry(chs_graph_prMeanvsNpv[1],"z_{cut}=0.05,r_{cut}=0.5","l");
leg_1D[5]->AddEntry(chs_graph_prMeanvsNpv[2],"z_{cut}=0.05,r_{cut}=0.75","l");
leg_1D[5]->AddEntry(chs_graph_prMeanvsNpv[3],"z_{cut}=0.1,r_{cut}=0.75","l");
leg_1D[5]->AddEntry(chs_graph_MeanvsNpv,"ungroomed ","l");
...
TMg_1D[6]->SetMaximum(120);
TMg_1D[6]->SetTitle(" ;n_{PV} ;< m_{pruning} > (GeV)");
TMg_1D[6]->Draw("AP");

leg_1D[6]->AddEntry(puppi_graph_prMeanvsNpv[0],"z_{cut}=0.1,r_{cut}=0.5","l");
leg_1D[6]->AddEntry(puppi_graph_prMeanvsNpv[1],"z_{cut}=0.05,r_{cut}=0.5","l");
leg_1D[6]->AddEntry(puppi_graph_prMeanvsNpv[2],"z_{cut}=0.05,r_{cut}=0.75","l");
leg_1D[6]->AddEntry(puppi_graph_prMeanvsNpv[3],"z_{cut}=0.1,r_{cut}=0.75","l");
...
TMg_1D[7]->SetMaximum(120);

TMg_1D[7]->SetTitle(" ;n_{PV} ;< m_{pruning} > (GeV)");
TMg_1D[7]->Draw("AP");

leg_1D[7]->AddEntry(gen_graph_prMeanvsNpv[0],"z_{cut}=0.1,r_{cut}=0.5","l");
leg_1D[7]->AddEntry(gen_graph_prMeanvsNpv[1],"z_{cut}=0.05,r_{cut}=0.5","l");
leg_1D[7]->AddEntry(gen_graph_prMeanvsNpv[2],"z_{cut}=0.05,r_{cut}=0.75","l");
leg_1D[7]->AddEntry(gen_graph_prMeanvsNpv[3],"z_{cut}=0.1,r_{cut}=0.75","l");
...
TMg_1D[8]->Add(pf_graph_MeanvsNpv);
...
leg_1D[8]->AddEntry(pf_graph_sdMeanvsNpv[0],"#beta = 2 ","l");
leg_1D[8]->AddEntry(pf_graph_sdMeanvsNpv[1],"#beta = 0 ","l");
leg_1D[8]->AddEntry(pf_graph_sdMeanvsNpv[2],"#beta = 1 ","l");
//leg_1D[8]->AddEntry(pf_graph_sdMeanvsNpv[3],"Softdrop #beta = -1 ","l");

leg_1D[8]->AddEntry(pf_graph_MeanvsNpv,"ungroomed ","l");
...
TMg_1D[9]->Add(chs_graph_MeanvsNpv);
...
leg_1D[9]->AddEntry(chs_graph_sdMeanvsNpv[0],"#beta = 2 ","l");
leg_1D[9]->AddEntry(chs_graph_sdMeanvsNpv[1],"#beta = 0 ","l");
leg_1D[9]->AddEntry(chs_graph_sdMeanvsNpv[2],"#beta = 1 ","l");
//leg_1D[9]->AddEntry(chs_graph_sdMeanvsNpv[3],"Softdrop #beta = -1 ","l");

leg_1D[9]->AddEntry(chs_graph_MeanvsNpv,"ungroomed ","l");
...
leg_1D[10]->AddEntry(puppi_graph_sdMeanvsNpv[0],"#beta = 2 ","l");
leg_1D[10]->AddEntry(puppi_graph_sdMeanvsNpv[1],"#beta = 0 ","l");
leg_1D[10]->AddEntry(puppi_graph_sdMeanvsNpv[2],"#beta = 1 ","l");
...
leg_1D[11]->AddEntry(gen_graph_sdMeanvsNpv[0],"#beta = 2 ","l");
leg_1D[11]->AddEntry(gen_graph_sdMeanvsNpv[1],"#beta = 0 ","l");
leg_1D[11]->AddEntry(gen_graph_sdMeanvsNpv[2],"#beta = 1 ","l");
...
sprintf(name,"AvJetmass_Vs_nPV_%ig.pdf",j1);
sprintf(namepng,"AvJetmass_Vs_nPV_%ig.png",j1);
cout<<"name = "<<name<<endl;
c_1D[j1]->SaveAs(name);
