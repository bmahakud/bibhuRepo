...
out = open("statusTest.%s.html" % groupName, "w")
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="my-table">
                                <div class="table-header">
                                    <p class="table-title">CRUZET (<a href="/event_display/RunList/TrendPlots/CRUZET.png">trend</a>, <a href="/event_display/RunList/TrendPlots/CRUZET_rate.png">rate</a> and <a href="/event_display/RunList/TrendPlots/CRUZET_cumul.png">cumul</a>)</p>
...
""" % (time.ctime() , allAlcaTracks_currentCRAFT / 1000. , maxcosmicrunforstat , abs(allLumi_currentCRAFT * 23.31 / 3600.) )
    outCOSMICTRACKS = open("Cosmics18test.hours.html", "w")
