...
// Tue Oct  6 19:38:47 2020 by ROOT version 6.18/04
// from TTree Events/Events
// found on file: F0CBE96B-7609-1E4A-92B4-A363DC94FAE6.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nmm;
   Float_t         mm_bdt[4];   //[nmm]
   Float_t         mm_doca[4];   //[nmm]
   Float_t         mm_docatrk[4];   //[nmm]
   Float_t         mm_gen_doca[4];   //[nmm]
   Float_t         mm_gen_l3d[4];   //[nmm]
   Float_t         mm_gen_lxy[4];   //[nmm]
   Float_t         mm_gen_mass[4];   //[nmm]
   Float_t         mm_gen_mu1_pt[4];   //[nmm]
   Float_t         mm_gen_mu2_pt[4];   //[nmm]
   Float_t         mm_gen_prod_z[4];   //[nmm]
   Float_t         mm_gen_pt[4];   //[nmm]
   Float_t         mm_gen_tau[4];   //[nmm]
   Float_t         mm_gen_vtx_x[4];   //[nmm]
   Float_t         mm_gen_vtx_y[4];   //[nmm]
   Float_t         mm_gen_vtx_z[4];   //[nmm]
   Float_t         mm_iso[4];   //[nmm]
   Float_t         mm_kal_lxy[4];   //[nmm]
   Float_t         mm_kal_mass[4];   //[nmm]
   Float_t         mm_kal_slxy[4];   //[nmm]
   Float_t         mm_kal_vtx_prob[4];   //[nmm]
   Float_t         mm_kin_alpha[4];   //[nmm]
   Float_t         mm_kin_alphaXY[4];   //[nmm]
   Float_t         mm_kin_cosAlphaXY[4];   //[nmm]
   Float_t         mm_kin_eta[4];   //[nmm]
   Float_t         mm_kin_l3d[4];   //[nmm]
   Float_t         mm_kin_lxy[4];   //[nmm]
   Float_t         mm_kin_mass[4];   //[nmm]
   Float_t         mm_kin_massErr[4];   //[nmm]
   Float_t         mm_kin_mu1eta[4];   //[nmm]
   Float_t         mm_kin_mu1phi[4];   //[nmm]
   Float_t         mm_kin_mu1pt[4];   //[nmm]
   Float_t         mm_kin_mu2eta[4];   //[nmm]
   Float_t         mm_kin_mu2phi[4];   //[nmm]
   Float_t         mm_kin_mu2pt[4];   //[nmm]
   Float_t         mm_kin_phi[4];   //[nmm]
   Float_t         mm_kin_pt[4];   //[nmm]
   Float_t         mm_kin_pv2lip[4];   //[nmm]
   Float_t         mm_kin_pv2lipErr[4];   //[nmm]
   Float_t         mm_kin_pv_z[4];   //[nmm]
   Float_t         mm_kin_pv_zErr[4];   //[nmm]
   Float_t         mm_kin_pvip[4];   //[nmm]
   Float_t         mm_kin_pvipErr[4];   //[nmm]
   Float_t         mm_kin_pvlip[4];   //[nmm]
   Float_t         mm_kin_pvlipErr[4];   //[nmm]
   Float_t         mm_kin_sl3d[4];   //[nmm]
   Float_t         mm_kin_slxy[4];   //[nmm]
   Float_t         mm_kin_tau[4];   //[nmm]
   Float_t         mm_kin_taue[4];   //[nmm]
   Float_t         mm_kin_tauxy[4];   //[nmm]
   Float_t         mm_kin_tauxye[4];   //[nmm]
   Float_t         mm_kin_vtx_chi2dof[4];   //[nmm]
   Float_t         mm_kin_vtx_prob[4];   //[nmm]
   Float_t         mm_kin_vtx_x[4];   //[nmm]
   Float_t         mm_kin_vtx_xErr[4];   //[nmm]
   Float_t         mm_kin_vtx_y[4];   //[nmm]
   Float_t         mm_kin_vtx_yErr[4];   //[nmm]
   Float_t         mm_kin_vtx_z[4];   //[nmm]
   Float_t         mm_kin_vtx_zErr[4];   //[nmm]
   Float_t         mm_kinpc_alpha[4];   //[nmm]
   Float_t         mm_kinpc_alphaXY[4];   //[nmm]
   Float_t         mm_kinpc_cosAlphaXY[4];   //[nmm]
   Float_t         mm_kinpc_eta[4];   //[nmm]
   Float_t         mm_kinpc_l3d[4];   //[nmm]
   Float_t         mm_kinpc_lxy[4];   //[nmm]
   Float_t         mm_kinpc_mass[4];   //[nmm]
   Float_t         mm_kinpc_massErr[4];   //[nmm]
   Float_t         mm_kinpc_phi[4];   //[nmm]
   Float_t         mm_kinpc_pt[4];   //[nmm]
   Float_t         mm_kinpc_pv2lip[4];   //[nmm]
   Float_t         mm_kinpc_pv2lipErr[4];   //[nmm]
   Float_t         mm_kinpc_pv_z[4];   //[nmm]
   Float_t         mm_kinpc_pv_zErr[4];   //[nmm]
   Float_t         mm_kinpc_pvip[4];   //[nmm]
   Float_t         mm_kinpc_pvipErr[4];   //[nmm]
   Float_t         mm_kinpc_pvlip[4];   //[nmm]
   Float_t         mm_kinpc_pvlipErr[4];   //[nmm]
   Float_t         mm_kinpc_sl3d[4];   //[nmm]
   Float_t         mm_kinpc_slxy[4];   //[nmm]
   Float_t         mm_kinpc_tau[4];   //[nmm]
   Float_t         mm_kinpc_taue[4];   //[nmm]
   Float_t         mm_kinpc_tauxy[4];   //[nmm]
   Float_t         mm_kinpc_tauxye[4];   //[nmm]
   Float_t         mm_kinpc_vtx_chi2dof[4];   //[nmm]
   Float_t         mm_kinpc_vtx_prob[4];   //[nmm]
   Float_t         mm_kinpc_vtx_x[4];   //[nmm]
   Float_t         mm_kinpc_vtx_xErr[4];   //[nmm]
   Float_t         mm_kinpc_vtx_y[4];   //[nmm]
   Float_t         mm_kinpc_vtx_yErr[4];   //[nmm]
   Float_t         mm_kinpc_vtx_z[4];   //[nmm]
   Float_t         mm_kinpc_vtx_zErr[4];   //[nmm]
   Float_t         mm_m1iso[4];   //[nmm]
   Float_t         mm_m2iso[4];   //[nmm]
   Float_t         mm_mass[4];   //[nmm]
   Float_t         mm_mu1_eta[4];   //[nmm]
   Float_t         mm_mu1_phi[4];   //[nmm]
   Float_t         mm_mu1_pt[4];   //[nmm]
   Float_t         mm_mu2_eta[4];   //[nmm]
   Float_t         mm_mu2_phi[4];   //[nmm]
   Float_t         mm_mu2_pt[4];   //[nmm]
   Float_t         mm_mva[4];   //[nmm]
   Float_t         mm_otherVtxMaxProb[4];   //[nmm]
   Float_t         mm_otherVtxMaxProb1[4];   //[nmm]
   Float_t         mm_otherVtxMaxProb2[4];   //[nmm]
   Int_t           mm_closetrk[4];   //[nmm]
   Int_t           mm_closetrks1[4];   //[nmm]
   Int_t           mm_closetrks2[4];   //[nmm]
   Int_t           mm_closetrks3[4];   //[nmm]
   Int_t           mm_gen_cpdgId[4];   //[nmm]
   Int_t           mm_gen_mpdgId[4];   //[nmm]
   Int_t           mm_gen_mu1_mpdgId[4];   //[nmm]
   Int_t           mm_gen_mu1_pdgId[4];   //[nmm]
   Int_t           mm_gen_mu2_mpdgId[4];   //[nmm]
   Int_t           mm_gen_mu2_pdgId[4];   //[nmm]
   Int_t           mm_gen_pdgId[4];   //[nmm]
   Int_t           mm_kal_valid[4];   //[nmm]
   Int_t           mm_kin_valid[4];   //[nmm]
   Int_t           mm_kinpc_valid[4];   //[nmm]
   Int_t           mm_mu1_index[4];   //[nmm]
   Int_t           mm_mu1_pdgId[4];   //[nmm]
   Int_t           mm_mu2_index[4];   //[nmm]
   Int_t           mm_mu2_pdgId[4];   //[nmm]
   Int_t           mm_nBMTrks[4];   //[nmm]
   Int_t           mm_nDisTrks[4];   //[nmm]
   Int_t           mm_nTrks[4];   //[nmm]
   UInt_t          ngensummary;
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[61];   //[nGenPart]
   Float_t         GenPart_mass[61];   //[nGenPart]
   Float_t         GenPart_phi[61];   //[nGenPart]
   Float_t         GenPart_pt[61];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[61];   //[nGenPart]
   Int_t           GenPart_pdgId[61];   //[nGenPart]
   Int_t           GenPart_status[61];   //[nGenPart]
   Int_t           GenPart_statusFlags[61];   //[nGenPart]
   UInt_t          nSubGenJetAK8;
   Float_t         SubGenJetAK8_eta[2];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_mass[2];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_phi[2];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_pt[2];   //[nSubGenJetAK8]
   ...
   Float_t         Jet_jercCHF[13];   //[nJet]
   Float_t         Jet_jercCHPUF[13];   //[nJet]
   ...
   Int_t           TrigObj_id[6];   //[nTrigObj]
   Int_t           TrigObj_l1iso[6];   //[nTrigObj]
   Int_t           TrigObj_l1charge[6];   //[nTrigObj]
   ...
   Int_t           PV_npvsGood;
   UInt_t          nSV;
   Float_t         SV_dlen[4];   //[nSV]
   Float_t         SV_dlenSig[4];   //[nSV]
   Float_t         SV_dxy[4];   //[nSV]
   Float_t         SV_dxySig[4];   //[nSV]
   Float_t         SV_pAngle[4];   //[nSV]
   ...
   Float_t         SV_chi2[4];   //[nSV]
   Float_t         SV_eta[4];   //[nSV]
   Float_t         SV_mass[4];   //[nSV]
   Float_t         SV_ndof[4];   //[nSV]
   Float_t         SV_phi[4];   //[nSV]
   Float_t         SV_pt[4];   //[nSV]
   Float_t         SV_x[4];   //[nSV]
   Float_t         SV_y[4];   //[nSV]
   Float_t         SV_z[4];   //[nSV]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("F0CBE96B-7609-1E4A-92B4-A363DC94FAE6.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("F0CBE96B-7609-1E4A-92B4-A363DC94FAE6.root");
      }
